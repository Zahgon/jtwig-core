...
public class AssignableTypes {
    ...
    private static final Map<Class, Class> BOXED_TYPE = ImmutableMap.<Class, Class>builder().put(Integer.TYPE, Integer.class).put(Float.TYPE, Float.class).put(Double.TYPE, Double.class).put(Long.TYPE, Long.class).put(Boolean.TYPE, Boolean.class).put(Character.TYPE, Character.class).build();
