...
public class CompositeNodeParser extends NodeParser<CompositeNode> {
    ...
    public static class NodeListParser extends BasicParser<Collection<Node>> {
        ...
        public NodeListParser(ParserContext context) {
            ...
            contentParsers = new ArrayList<>(Arrays.<Class>asList(BlockNodeParser.class, EmbedNodeParser.class, ForLoopNodeParser.class, IfNodeParser.class, ImportSelfNodeParser.class, ImportNodeParser.class, IncludeNodeParser.class, MacroNodeParser.class, OutputNodeParser.class, SetNodeParser.class, DoNodeParser.class, FlushNodeParser.class, VerbatimNodeParser.class, AutoEscapeNodeParser.class, ContentEscapeNodeParser.class, FilterNodeParser.class, TextNodeParser.class));
